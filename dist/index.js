...
exports.deriveFromSeed = exports.deriveFromKey = exports.isValidPath = exports.getPublicKey = exports.getMasterKeyFromSeed = void 0;
...
exports.deriveFromKey = (path, masterKey) => {
...
exports.deriveFromSeed = (path, seed) => {
    return exports.deriveFromKey(path, exports.getMasterKeyFromSeed(seed));
};
